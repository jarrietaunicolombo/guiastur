<?php
require_once $_SERVER["DOCUMENT_ROOT"] . "guiastur/Application/Contracts/ExternalServices/IEmailSender.php";
...
class EmailSender implements IEmailSender {
    ...
    private $userServer = 'CUENTA DE CORREO';
    private $userName = 'Gestor de Turnos Para Guias de Turismo';
    private $passServer = "CONTRASEÑA";
    ...
    public function send(EmailDestinationModel $request) : string{
        try{
            ...
            return "No pudo ser enviada la notificacion al correo ".$request->getDestinationEmail();
        } 
    }
}
