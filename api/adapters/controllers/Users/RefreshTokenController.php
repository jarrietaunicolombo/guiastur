...
require_once $_SERVER["DOCUMENT_ROOT"] . "/guiastur/api/application/services/Auth/TokenService.php";
require_once $_SERVER["DOCUMENT_ROOT"] . "/guiastur/api/application/services/Users/UserService.php";
require_once $_SERVER["DOCUMENT_ROOT"] . "/guiastur/api/application/services/HTTP/ResponseService.php";
require_once $_SERVER["DOCUMENT_ROOT"] . "/guiastur/api/infrastructure/Helpers/CookiesSetup.php";
require_once $_SERVER["DOCUMENT_ROOT"] . "/guiastur/api/application/Exceptions/UnauthorizedException.php";
